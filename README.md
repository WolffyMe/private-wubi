原项目地址[search-wubi](https://github.com/hantang/search-wubi)

由于我并不是很了解Github，不清楚Fork后有没有什么副作用（比如：原作者修改项目后如果我也更新，如果我想回退，好像比较麻烦），所以我索性把作者源代码进行下载并上传到自己的仓库

在此声明：该项目及部署后的网站仅供自用，永远不会用作商用
